...
/*    */ {
	/* 18 */ public static AtomicInteger getCounter() {
		return counter;
	}
	...
	/*    */ {
		/* 34 */ ItemStack banner = new ItemStack(Material.LEGACY_BANNER);
		/* 35 */ return banner;
		/*    */ }
	...
	/*    */
	/*    */
	/*    */ public abstract ItemStack getBanner(DyeColor paramDyeColor1, DyeColor paramDyeColor2,
