...
/* 19 */     bannerMeta.addPattern(new Pattern(foreGroundColor, PatternType.STRIPE_TOP));
...
/* 23 */     bannerMeta.addPattern(new Pattern(foreGroundColor, PatternType.SQUARE_BOTTOM_RIGHT));
