...
public class Ranking{
   ...
   //This creates a blank page with the next and prev buttons
    private Inventory getBlankPage(String name){
        ...
        ItemStack nextpage =  new ItemStack(Heads.getSkull("http://textures.minecraft.net/texture/fa87e3d96e1cfeb9ccfb3ba53a217faf5249e285533b271a2fb284c30dbd9829"));
        ItemMeta meta = nextpage.getItemMeta();
        meta.setDisplayName("§aPágina "+(atual + 1));
        nextpage.setItemMeta(meta);

        ItemStack prevpage = new ItemStack(Heads.getSkull("http://textures.minecraft.net/texture/da1d55b3f989410a34752650e248c9b6c1783a7ec2aa3fd7787bdc4d0e637d39"));
        meta = prevpage.getItemMeta();
        meta.setDisplayName("§aPágina "+(atual - 1));
        prevpage.setItemMeta(meta);

        page.setItem(47, new ItemBuilder(Heads.getSkull("http://textures.minecraft.net/texture/223fb67429716b21bc6e8e7d669ceddf65b13e0790a5ce55b2e077b82d19e124")).setName("§aVoltar").toItemStack());
        switch (this.rank) {
		case COINS:
	        ...
	        page.setItem(52, new ItemBuilder(Heads.CINZA.clone()).setName("§eOrdenar por Invasoes").setLore("§7Clique para ordernar por invasoes.").toItemStack());
			break;
		case KDR:
		...
		case INVASOES:
	        ...
	        page.setItem(50, new ItemBuilder(Heads.CINZA.clone()).setName("§eOrdenar por Geradores").setLore("§7Clique para ordernar por geradores.").toItemStack());
	        page.setItem(51, new ItemBuilder(Heads.CINZA.clone()).setName("§eOrdenar por Poder").setLore("§7Clique para ordernar por poder.").toItemStack());
	        page.setItem(52, new ItemBuilder(Heads.VERDE.clone()).setName("§eOrdenar por Invasoes").setLore("§7Clique para ordernar por invasoes.").toItemStack());
			break;
        }
